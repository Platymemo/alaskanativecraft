...
public class AlaskaRecipes {
    ...
    public static RecipeType<DryingRecipe> DRYING = Registry.register(Registry.RECIPE_TYPE, new Identifier(AlaskaNativeCraft.MOD_ID, "drying"), new RecipeType<DryingRecipe>() {
        public String toString() {
            return "drying";
        }
    });
    public static CookingRecipeSerializer<DryingRecipe> DRYING_SERIALIZER = Registry.register(Registry.RECIPE_SERIALIZER, new Identifier(AlaskaNativeCraft.MOD_ID, "drying"), new CookingRecipeSerializer<>(DryingRecipe::new, 1200));
